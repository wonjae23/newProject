    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="form-group">
            	...
            	<div class="col-sm-10">
            		<input type="text" id="subject" name="subject" class="form-control" value="${boardView.subject}" readonly="readonly"/>
            	</div>
            </div>
            ...
            <div class="form-group">
            	<button id="modify" name="modify" class="btn btn-primary">글 수정</button>
            	<button id="delete" name="delete" class="btn btn-success">글 삭제</button>
            	<button id="list" name="list" class="btn btn-info">목록</button>
            </div><br>
